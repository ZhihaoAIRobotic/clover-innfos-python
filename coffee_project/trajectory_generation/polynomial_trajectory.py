...
if __name__ == '__main__':
    ...
    q0 = [0, 0, -1.56600001, -1.6190000, 1.67200000, 0]
    dq0 = [0, 0, 0, 0, 0, 0]
    ddq0 = [0, 0, 0, 0, 0, 0]
    ...
    # via_points = np.load('joint_path_100_points.npy')

    # t_list = np.array([10.0, 15.0, 20.0, 21.0])
    t_list = np.linspace(0.4, 40, 100)
    # print(t_list)
    # n_list = np.array([50, 50, 50, 50])
