# PID control for a set of via points
...
q = np.array([[0, 0, -np.pi / 2, -np.pi / 2, np.pi / 2, 0],
              [0.07727, 0.1417, -1.775, -0.7093, 2.057, -0.8062],
              [0.1149, 0.1325, -1.846, -0.8331, 2.18, -0.6235]])
