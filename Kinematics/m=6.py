...
if __name__ == "__main__":
    ...
    joint_value = [1.2, 1.4, -1.2, 1.1, 0.2, 0.5]
    ...
    Inverse_kinematics, condition, thetalist, jab, dq = ik(robot_chain, [0, 0, 0, 0, 0, 0], forward_kinematics, 1000, 0.1, method="Quaternion")
